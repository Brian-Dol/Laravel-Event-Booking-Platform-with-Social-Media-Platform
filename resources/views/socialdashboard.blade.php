                        ...
                        <section id="posts" class="posts">
                            ...
                            <br>
                                <div class="card-body p-0 d-flex">
                                    ...
                                    <h4 class="fw-700 text-grey-900 font-xssss mt-1">{{$post->customer->first_name}} {{$post->customer->last_name}}<span class="d-block font-xssss fw-500 mt-1 lh-3 text-grey-500">{{ $post->created_at->diffForHumans() }}</span></h4>
                                ...
                                <div class="card-body p-0 me-lg-5">
                                    <p class="fw-500 text-grey-500 lh-26 font-xssss w-100">{{ $post->body }}
                                    </p>
                                </div>
                                ...
                                <div class="card-body d-flex p-0">
                                    ...
                                    <div class="card-body d-flex align-items-center pt-0 ps-4 pe-4 pb-4">
                                        <a href="{{ route('edit_post', ['post_id' => $post->id]) }}" class="p-2 lh-20 w100 bg-grey text-grey-800 text-center font-xssss fw-600 ls-1 rounded-xl">Edit</a>



                                        
                                        <a onclick="return confirm('Are you sure you want to delete this post?')" href="{{ url('social-home/deletepost/'.$post->id) }}" class="p-2 lh-20 w100 bg-primary-gradiant me-2 text-white text-center font-xssss fw-600 ls-1 rounded-xl">Delete</a>
                                    </div>
