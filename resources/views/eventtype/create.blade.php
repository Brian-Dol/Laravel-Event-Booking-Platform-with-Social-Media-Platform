...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Add Event Type
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <form method="post" action="{{url('admin/eventtype')}}">
                    @csrf
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td> <textarea class="form-control" name="detail" ></textarea>
                            </td>
